...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/RNVectorIcons/Fonts/FontAwesome5_Brands.ttf"
  install_resource "${PODS_ROOT}/RNVectorIcons/Fonts/FontAwesome5_Regular.ttf"
  install_resource "${PODS_ROOT}/RNVectorIcons/Fonts/FontAwesome5_Solid.ttf"
